...
('id4', '김코딩', 1, 4.0, '편의점 김밥 중 최고예요.'),
('id5', '박리뷰', 3, 5.0, '치킨마요 맛있어요! 또 먹고 싶어요.'),
('id6', '최유저', 5, 4.2, '라면은 언제나 진라면~'),
('id7', '송새싹', 10, 3.8, '비타500은 언제 마셔도 좋아요.'),
('id8', '이인턴', 12, 4.5, '바나나 우유는 역시 빙그레가 최고죠.'),
('id9', '정리뷰', 15, 2.5, '생각보다 평범한 맛이었어요.'),
('id10', '김현장', 19, 4.8, '초코 맛 진해서 좋음. 여름엔 무조건 이거.'),
('id1', '이유민', 21, 3.0, '술 맛은 괜찮지만 좀 독해요.'),
('id2', '반충기', 24, 5.0, '여행 갈 때 하나씩 꼭 챙겨요.'),
('id2', '반충기', 1, 4.2, '아침 대용으로 딱 좋아요.'),
('id3', '홍길동', 1, 3.8, '참치 양이 좀 더 많았으면...'),
('id4', '김코딩', 2, 4.7, '편의점 도시락 중 탑급! 맛도 푸짐.'),
('id5', '박리뷰', 2, 4.5, '전자레인지 돌리면 향이 끝내줘요.'),
('id6', '최유저', 4, 3.5, '빵이 조금 마른 느낌이 있었어요.'),
('id7', '송새싹', 4, 4.1, '햄치즈 조합은 언제나 진리.'),
('id8', '이인턴', 8, 4.9, '맵찔이는 주의! 하지만 중독성 있음.'),
('id4', '김코딩', 21, 4.0, '시원하게 먹으면 꿀맛. 무난함.'),
('id3', '홍길동', 13, 3.7, '아이스티 향이 진해서 마음에 듬.'),
('id6', '최유저', 25, 4.9, '가성비 갑. 외출 필수템.');
...
('id6', '최유저', 1, 4.4, '자주 이용하는 매장, 물건 진열 상태도 좋아요.'),
('id7', '송새싹', 1, 4.7, '주변에 편하게 들를 수 있는 편의점!'),
('id8', '이인턴', 2, 4.5, '음료 종류가 다양해서 좋아요.'),
('id9', '정리뷰', 2, 3.9, '직원 응대는 보통, 매장 상태는 양호.'),
('id10', '김현장', 3, 4.8, '기본이 잘 되어있는 느낌. 깔끔하고 빠름.'),
('id1', '이유민', 3, 4.2, '대체로 만족, 위치가 좋아요.'),
('id2', '반충기', 4, 3.8, '야간에도 운영해서 유용함.'),
('id3', '홍길동', 4, 4.0, '주차가 아쉬운 점 빼고는 만족.'),
('id4', '김코딩', 5, 4.9, '신축 매장이라 그런지 정말 깨끗함.'),
('id5', '박리뷰', 5, 4.6, '친절한 응대와 빠른 결제 시스템이 인상적.'),
('id10', '김현장', 6, 4.6, '편리한 위치에 있어요.'),
('id6', '최유저', 6, 4.1, '공단 근처에서 제일 자주 가는 곳.'),
('id7', '송새싹', 6, 3.7, '품절이 가끔 있어요. 그래도 기본은 충실.'),
('id8', '이인턴', 7, 4.4, '사람이 많아도 회전이 빠릅니다.'),
('id9', '정리뷰', 7, 4.0, '편하게 들르기 좋은 곳이에요.');
